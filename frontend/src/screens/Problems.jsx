...
import { getProblemsProgress, updateProblemProgress } from '../utils/api'
...
export default function Problems() {
  ...
  useEffect(() => {
    fetch('/polgar.json').then(r => r.json()).then(setData).catch(console.warn)
  }, [])
    ...
    <div style={{ display: 'flex', flex: 1, overflow: 'hidden' }}>
      ...
      <div className="sidebar">
        <div className="sidebar-head">
          <span style={{ fontSize: 13, fontWeight: 500 }}>Polgár 5334</span>
        </div>
